...
<div class="containersearch">
    <p style="font-size: 20px; color: #071359; margin-bottom: 13px" class="text-center"><strong>Listado de empleados de alta</strong></p>
    <form id="searchForm" action="/empleados" method="GET" class="mb-3 text-right">
        <div class="SearchAndShow block">
            <div class="mx-auto">
                ...
                <a href="/empleados" class="btn-ver">Ver todos</a>
            </div>
        </div>
    </form>
</div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<td class='text-center'><button class='btn-update' onclick=\"window.location.href='/modificar-empleado?id_empleado=" . $row['Id_empleado'] . "&from=empleados';\" title='Modificar datos'><span class='material-symbols-outlined'>edit</span></button></td>";
            ...
            $countSql = "SELECT COUNT(*) as total FROM Dtos_Personales dp JOIN InfoEmpresarial ie ON dp.ID = ie.Id_Empleado WHERE Estado='Activo'";
            if (isset($_GET['searchQuery']) && !empty($_GET['searchQuery'])) {
